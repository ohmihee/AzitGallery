...
const SignUp = () => {
  ...
  const nickChk1 = async (e) => {
    ...
    setNickErr(value === "");
    setNickLength3Err(
      (value.length < 3 && value.length > 0) || value.length > 20
    );
        ...
        <div className="layout">
          <div className="signUpContainer">
            <form>
                ...
                <tbody>
                  <tr>
                    <td>
                      <table className="width100">
                        <tbody>
                          <tr>
                            <td className="textLeft pageSubtitleBold">
                              닉네임
                            </td>
                            <td className="sideSubtitle">
                              * 5~20자의 한글, 영문 대소문자, 숫자,
                              특수기호(_),(-),(.)만 사용 가능합니다.
                            </td>
                          </tr>
                        </tbody>
                  ...
                  <tr>
                    <td>
                      ...
                      />
                      {emailErr ? (
                        <div className="error">이메일 주소를 입력해주세요.</div>
                      ) : (
                        <>
                          {" "}
                          {email2Err ? (
                      ...
                      <div>
                        <div className="mBottom">
                          ...
                          {checked1 ? (
                            ...
                            <div className="error">
                              AzitGallery는 만 19세 이상만 이용 가능합니다.
                            </div>
                          )}
                        </div>
                      </div>
              ...
              <div className="btn3">
                <a className="cancelBtn" onClick={() => Router.back()}>
                  취소
                </a>
                <button
                  type="button"
