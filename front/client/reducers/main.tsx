...
export const CATEGORY_SELECT_ITEM_REQUEST =
  "CATEGORY_SELECT_ITEM_REQUEST" as const;
export const CATEGORY_SELECT_ITEM_SUCCESS =
  "CATEGORY_SELECT_ITEM_SUCCESS" as const;
...
const reducer = (state: MainState = initialState, action: MainAction) => {
  switch (action.type) {
    ...
    case ALL_CATEGORY_SUCCESS:
      //   console.log(action, "dataresuilt===");
      return {
        ...state,
